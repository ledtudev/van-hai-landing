  ...
  return (
    <div className="font-sans" id="vi-tri">
      ...
      <section className="relative overflow-hidden bg-[#fff9f0] py-16 md:py-20">
        {/* Background Waves - Realistic side patterns */}
        <div
        ...
        <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center px-4 text-center">
          <h2 className="mb-6 text-2xl font-bold capitalize text-[#5a4638] drop-shadow-sm md:text-3xl">
            Vị Trí Độc Tôn Giữa Núi Hải Vân Và Vịnh Biển Đà Nẵng
          </h2>

          <p className="mb-10 max-w-4xl text-sm leading-relaxed text-[#6a5a4e] md:text-base">
            ...
            trong xanh của{" "}
            <strong className="text-[#333]">Đà Nẵng</strong>, mang đến không
            gian sống nghỉ dưỡng đẳng cấp và biệt lập.
          </p>

          <div className="mb-10 w-full max-w-4xl transform overflow-hidden rounded-xl border-[8px] border-white shadow-[0_15px_50px_rgba(0,0,0,0.12)] transition-transform duration-500 hover:scale-[1.01]">
            <img
          ...
          <p className="mb-10 max-w-4xl text-sm leading-relaxed text-[#6a5a4e] md:text-base">
            ...
            sân bay quốc tế Đà Nẵng và các điểm du lịch nổi tiếng của miền
            Trung. Nhờ vị trí chiến lược cùng hạ tầng giao thông đang phát triển
            mạnh,{" "}
            <strong className="text-[#333]">Vinhomes Hải Vân Bay</strong> không
            chỉ là nơi an cư lý tưởng mà còn mở ra cơ hội đầu tư hấp dẫn cho
            những khách hàng muốn sở hữu bất động sản biển đẳng cấp.
          </p>

          <button className="flex items-center gap-2 rounded-full border border-[#5a4638] px-8 py-2.5 text-sm font-semibold text-[#5a4638] transition-all duration-300 hover:bg-[#5a4638] hover:text-white">
