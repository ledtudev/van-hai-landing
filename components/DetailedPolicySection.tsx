...
const POLICY_CARDS = [
  ...
  },
  {
    ...
    desc: 'Dự án Vinhomes Làng Vân mang đến lợi thế lớn khi 92% sản phẩm được sở hữu lâu dài, bao gồm liền kề, shophouse, biệt thự, căn hộ cao cấp. Đây là yếu tố cực kỳ quan trọng, không chỉ gia tăng tính thanh khoản mà còn đảm bảo giá trị tài sản được bền vững theo thời gian.',
    details: [
  ...
  },
  {
    ...
    note: 'Với phương thức thanh toán đa dạng và các gói hỗ trợ lãi suất cực tốt, Bạch Vân không chỉ là nơi an cư lý tưởng giữa hàng ngàn thiên nhiên mà còn là bài toán đầu tư an toàn, đón đầu chu kỳ tăng trưởng mới của Tây Bắc Đà Nẵng.'
  }
];
...
export function DetailedPolicySection() {
  return (
    <section className="relative bg-[#fff9f0] py-16 md:py-20 overflow-hidden font-sans border-t border-gray-100" id="bang-gia">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {POLICY_CARDS.map((card, idx) => (
            <div key={idx} className="bg-[#4a3b32] text-white p-6 rounded-xl shadow-lg border border-white/5">
        ...
        <div className="mt-8 text-center max-w-4xl mx-auto">
          <p className="text-[11px] text-gray-500 italic mb-4">
            Lưu ý quan trọng: Bảng giá trên là mức giá Rumor dự báo từ các chuyên gia thị trường dựa trên định vị phân khu. Giá bán chính thức sẽ biến động tùy thuộc vào mã căn, vị thế lô góc, mặt đường lớn 35m hay hướng view trực diện ra biển/Suối Lương.
          </p>
          <p className="text-xs text-gray-700 leading-relaxed font-medium">
            Với chính sách tài chính ưu việt, hỗ trợ lãi suất dài hạn, phương thức thanh toán linh hoạt và quyền sở hữu lâu dài cho phần lớn sản phẩm, Vinhomes Hải Vân Bay trở thành lựa chọn hấp dẫn cho cả khách hàng an cư và nhà đầu tư tại thị trường bất động sản biển Đà Nẵng.
          </p>
        </div>
      </div>
    </section>
